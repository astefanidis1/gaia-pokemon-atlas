/* GAIA ecology integration: regional explorer, seasonal layers, and ecological relationships. */
  ...
  function installEcologyInterface() {
    ...
    if(launch){launch.id='regionalExplorerButton';launch.innerHTML=`<span><b>Regional Explorer</b><small>${regions.length} field windows · live seasonal ecology</small></span><i>Open →</i>`;}
